An implementation of Conway's Game of Life in Java that runs in the terminal with a 25x25 cell grid. Each live cell is represented by 'O' and each dead cell by '-'.
